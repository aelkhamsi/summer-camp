    ...
    > 
      ...
      <div className="w-full flex flex-col items-center max-w-2xl space-y-6">
        ...
        <div className="w-[50rem] md:w-[80rem] relative">
          ...
          <div className="absolute inset-x-80 top-0 bg-gradient-to-r from-transparent via-[#00FCFE] to-transparent h-[5px] md:w-2/4 blur-sm" />
          <div className="absolute inset-x-80 top-0 bg-gradient-to-r from-transparent via-[#00FCFE] to-transparent h-px md:w-2/4" />
        </div>
