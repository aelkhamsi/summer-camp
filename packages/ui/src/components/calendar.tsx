...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@mdm/ui"
    ...
    <DayPicker
      ...
      components={{
        ...
        Dropdown: ({ ...props }) => (
          ...
          >
            <SelectTrigger className={cn(buttonVariants({ variant: "ghost" }), " px-2 mx-2 py-1 h-7 border-none shadow-none font-medium [.is-between_&]:hidden [.is-end_&]:hidden [.is-start.is-end_&]:flex")}>
